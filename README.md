About napari-hdf5-labels-io-feedstock
=====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-hdf5-labels-io-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15523&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-hdf5-labels-io-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-hdf5-labels-io` can be installed with `conda`:
...
```
mamba install napari-hdf5-labels-io
```

It is possible to list all of the versions of `napari-hdf5-labels-io` available on your platform with `conda`:
...
```
mamba search napari-hdf5-labels-io --channel conda-forge
```
...
mamba repoquery search napari-hdf5-labels-io --channel conda-forge

# List packages depending on `napari-hdf5-labels-io`:
mamba repoquery whoneeds napari-hdf5-labels-io --channel conda-forge

# List dependencies of `napari-hdf5-labels-io`:
mamba repoquery depends napari-hdf5-labels-io --channel conda-forge
```
